      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-12 max-w-md w-full mx-4 border border-slate-200">
          <div className="text-center">
            ...
            <p className="text-slate-600">You need to be authenticated to access this page</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">Manage your restaurant information and account settings</p>
              </div>
            </div>
          </div>
